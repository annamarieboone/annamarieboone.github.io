<script>
    ...
    onMount(() => {
        ...
        .type("hi! i'm anna marie boone, a digital designer")
        .pause(500)
        .move(-9)
        .delete(7)
        .pause(150)
        .type("sometimes-print")
        .pause(500)
        .move(9)
        .delete(25)
        .type(" writer")
...
<div class="hero">
    ...
    <div class="hero-intro">
        <div class="text-wrapper">
            <h3>I work at the <a href="https://www.startribune.com/" target="_blank" rel="noopener noreferrer   ">Minnesota Star Tribune,</a> where I use code and persistence to build and tell visual stories.</h3>
